...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(handlers::account::get_saved_this_month)
            ...
            .service(handlers::account::get_budget_spent_history)
            ...
            .service(handlers::dashboard_api::update_dashboard)
            ...
            .service(handlers::reimbursement::get_reimbursements_summary_api)
            .service(handlers::reimbursement::refresh_reimbursements)
